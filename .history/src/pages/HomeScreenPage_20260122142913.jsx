          ...
          <div className="featured-glass">
            <div className="section-header">
              ...
              <button 
                ...
                title={language === "en" ? "Get new random flower" : "Ottieni un nuovo fiore casuale"}
              >
        ...
        <section className="time-sections-glass">
          <div className="time-section-glass morning">
            <div className="time-section-header">
              ...
              <div>
                <h3>
                  {language === "en" ? "Morning Dew" : "Rugiada Mattutina"}
                </h3>
                <p>
                  {language === "en"
          ...
          <div className="time-section-glass midday">
            <div className="time-section-header">
              ...
              <div>
                <h3>
                  {language === "en" ? "Noon Light" : "Luce di Mezzogiorno"}
                </h3>
                <p>
                  {language === "en"
            ...
            <div className="time-flowers-scroll">
              {flowers
                .filter(
                  (f) =>
                    f.DayTime[language] ===
                    (language === "en" ? "Midday" : "Mezzogiorno"),
                )
                .slice(0, 3)
                .map((flower) => (
                  <FlowerCard
          ...
          <div className="time-section-glass evening">
            <div className="time-section-header">
              ...
              <div>
                <h3>
                  {language === "en" ? "Evening Stars" : "Stelle della Sera"}
                </h3>
                <p>
                  {language === "en"
