...
export default function HomeScreenPage() {
  ...
  const groupedFlowers = {
    morning: flowers.filter(f => f.DayTime[language] === (language === "en" ? "Morning" : "Mattina")),
    midday: flowers.filter(f => f.DayTime[language] === (language === "en" ? "Midday" : "Mezzogiorno")),
    evening: flowers.filter(f => f.DayTime[language] === (language === "en" ? "Evening" : "Sera"))
  };
    ...
    <div className="home-screen">
      ...
      <div className="home-content">
        ...
        <div className="welcome-banner">
          <h1>🌸 {language === "en" ? "Your Spiritual Garden" : "Il Tuo Giardino Spirituale"} 🌸</h1>
          <p>
            {language === "en"
        ...
        <div className="time-sections">
          ...
          <div className="time-section morning-section">
            <div className="time-header">
              ...
              <h2>{language === "en" ? "Morning Prayers" : "Preghiere del Mattino"}</h2>
            </div>
          ...
          <div className="time-section midday-section">
            <div className="time-header">
              ...
              <h2>{language === "en" ? "Midday Prayers" : "Preghiere del Mezzogiorno"}</h2>
            </div>
            <div className="flowers-masonry">
          ...
          <div className="time-section evening-section">
            <div className="time-header">
              <span className="time-icon">🌙</span>
              <h2>{language === "en" ? "Evening Prayers" : "Preghiere della Sera"}</h2>
            </div>
            <div className="flowers-masonry">
