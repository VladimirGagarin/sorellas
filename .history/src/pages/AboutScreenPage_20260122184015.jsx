...
export default function AboutScreenPage() {
    ...
    const aboutArticles = [
        ...
        {articleTitle: {en: "Contact Us", it: "Contattaci"}, articleContent: {en: "We would love to hear from you! Whether you have feedback, questions, or just want to share your experience with Fiori di Preghiera, feel free to reach
    ]
