...
export default function AboutScreenPage() {
    ...
    const aboutArticles = [
        ...
        {articleTitle:{en: "Roses Of Rome Pictures", it: "Rose Di Roma Immagini"}, articleContent:{en: "Roses Of Rome Pictures is a film industry company that specializes in creating high-quality visual content for various media platforms. Their expertise lies in capturing the essence of stories through stunning imagery and cinematic techniques. We  are  connoisuers of  film music and  animation. We are passionate about bringing stories to life through visual storytelling. We are  also passionate  in blooming  this website 'Fiori Di Preghiera' and we hope this website will be  inspiring and  blessful to", it: "Roses Of Rome Pictures è una società del settore cinematografico specializzata nella creazione di contenuti visivi di alta qualità per varie piattaforme mediatiche. La loro esperienza risiede nel catturare l'essenza delle storie attraverso immagini straordinarie e tecniche cinematografiche. Siamo esperti di musica cinematografica e animazione. Siamo appassionati di portare le storie alla vita attraverso la narrativa visiva." } },
     ]
