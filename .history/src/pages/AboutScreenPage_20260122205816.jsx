...
export default function AboutScreenPage() {
  ...
  en: "To cultivate a sacred digital sanctuary where technology humbly serves the soul—inviting hearts into daily moments of prayer, reflection, and quiet beauty, expressed through the timeless and symbolic language of flowers.",
  it: "Coltivare un santuario digitale sacro dove la tecnologia si pone al servizio dell’anima, invitando i cuori a momenti quotidiani di preghiera, riflessione e silenziosa bellezza, espressi attraverso il linguaggio eterno e simbolico dei fiori.",
};
