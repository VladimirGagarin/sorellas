  ...
  const aboutArticles = [
    {
      ...
      links: [
        {
          name: "Website",
          url: "https://example.com/fiori-di-preghiera",
          icon: <FaGlobe />,
        },
      ],
      stats: [
    ...
    },
    {
      ...
      links: [
        {
          name: "Download App",
          url: "https://play.google.com/store/apps/details?id=com.rosesofrome.fioridipreghiera",
          icon: <FaGooglePlay />,
        },
      ],
      features: [
      ...
      <div className="about-container">
            ...
            <div className="app-section">
              <div className="app-hero">
                <div className="app-info">
                  ...
                  <a
                    href="https://play.google.com/store/apps/details?id=com.rosesofrome.fioridipreghiera"
                    target="_blank"
                    rel="noopener noreferrer"
        ...
        <div className="about-cta">
          ...
          <div className="cta-buttons">
            ...
            <a
              href="https://example.com/fiori-di-preghiera"
              target="_blank"
              rel="noopener noreferrer"
