...
export default function Header() {
  ...
  const translations = {
    en: {
      ...
      welcome: isDarkMode ? "Welcome to the Mystical Garden" : "Welcome to the Spiritual Garden",
      menu: "Garden Paths",
      themeToggle: isDarkMode ? "Light Garden" : "Mystical Garden",
      themeLabel: isDarkMode ? "Switch to Light Theme" : "Switch to Dark Theme",
      themeDesc: isDarkMode ? "Switch to light garden" : "Switch to mystical purple garden"
    },
    it: {
      appName: "Fiori Di Preghiera",
      ...
      welcome: isDarkMode ? "Benvenuto nel Giardino Mistico" : "Benvenuto nel Giardino Spirituale",
      ...
      themeDesc: isDarkMode ? "Passa al giardino luminoso" : "Passa al giardino mistico viola"
    }
  };
  ...
  const getFlowerColor = (flowerType) => {
    if (isDarkMode) {
      switch(flowerType) {
        case 'rose': return '#F472B6'; // Blush pink
        case 'lily': return '#D8B4FE'; // Lavender
        case 'oak': return '#FBBF24';  // Golden
        case 'leaf': return '#10B981'; // Emerald
        default: return '#C4B5FD';     // Lavender
      }
    } else {
      switch(flowerType) {
        case 'rose': return '#E91E63'; // Pink
        case 'lily': return '#9C27B0'; // Purple
        case 'oak': return '#5D4037';  // Brown
        case 'leaf': return '#2E7D32'; // Green
  ...
  const drawerItems = [
    ...
    { 
      ...
      label: t.gratitude, 
      link: "/gratitude",
      description: language === "en" ? "Rose - Gratitude Prayers" : "Rosa - Preghiere di Gratitudine",
    ...
    { 
      ...
      label: t.healing, 
      link: "/healing",
      description: language === "en" ? "Lily - Healing Intentions" : "Giglio - Intenzioni di Guarigione",
    ...
    { 
      ...
      label: t.reflections, 
      link: "/reflections",
      description: language === "en" ? "Oak - Deep Reflections" : "Quercia - Riflessioni Profonde",
